...
public:
    ...
    void Init()
    {
       ...
       // m_VSplitter = new ImGuiWidget::ImVerticalSplitter("VSplitter0");
        ...
        m_Splitter->AddPart(m_Box);
        m_Splitter->AddPart(Box1);
        m_Splitter->AddPart(ScrollBox0);
        ...
        m_Canvas->AddChildToCanvasPanel(m_Splitter)->SetSlotPosAndSize(ImVec2(500, 500), ImVec2(400, 200));
