...
namespace ImGuiWidget
{
    ImMultiLineTextBlock::ImMultiLineTextBlock(const std::string& WidgetName)
        : ImWidget(WidgetName)
    {
    }

    void ImMultiLineTextBlock::SetText(const std::string& Text)
    {
        if (m_Text != Text)
        {
            m_Text = Text;
    ...
    void ImMultiLineTextBlock::SetTextColor(ImU32 Color)
    {
        m_TextColor = Color;
    }

    void ImMultiLineTextBlock::SetBackgroundColor(ImU32 Color)
    {
        m_BackgroundColor = Color;
    }

    void ImMultiLineTextBlock::SetSelectionColor(ImU32 Color)
    {
        m_SelectionColor = Color;
    }

    void ImMultiLineTextBlock::SetLineSpacing(float Spacing)
    {
        m_LineSpacing = Spacing;
    }

    ImVec2 ImMultiLineTextBlock::GetMinSize()
    {
    ...
    void ImMultiLineTextBlock::WrapText()
    {
        m_Lines.clear();
        m_LineWidths.clear();
    ...
    int ImMultiLineTextBlock::GetCharIndexAtPosition(ImVec2 pos) const
    {
    ...
    void ImMultiLineTextBlock::HandleSelection()
    {
    ...
    void ImMultiLineTextBlock::SetSelectionByRect()
    {
        // 计算矩形覆盖的文本范围
    ...
    void ImMultiLineTextBlock::CopyAllSelectedTexts()
    {
    ...
    void ImMultiLineTextBlock::Render()
    {
        if (m_TextDirty) WrapText();
